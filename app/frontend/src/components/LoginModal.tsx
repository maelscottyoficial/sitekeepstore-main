...
export default function LoginModal({ isOpen, onClose, onSwitchToRegister }: LoginModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="bg-[#1a1a2e] border-white/10 p-0 sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#1a1a2e] px-3 text-gray-500">ou continue com</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-[#0a0a0f] py-2.5 text-sm font-medium text-gray-300 transition-colors hover:bg-white/5 hover:text-white"
            >
